...
var JSONgetter = function (http, resultname) {
  $.getJSON(http, function (resultname) {
    ...
    $.each(resultname, function (i, field) {
      console.log(field);
      if (catArr == field.category) {
        test = catArr.name;
        console.log(test);
      }
      var bigCard = "<div class='small-12 medium-12 large-6'> \
