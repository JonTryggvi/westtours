          ...
          for (var c = 0; c < wpData.trips.length; c++) {
            ...
            if (wpTripId == iActId) {
              ...
              $.post(templateUrl + "/library/bokun.php?checkprice=true", {
                ...
                var cookieTrip = Object.assign({}, jTrip, {});
                cookieTrip.rateId = ajFiltered[0][0].rate.id;
                $.get(rootUrl + apiUrl, function(wpPostData) {
                  ...
                  // console.log(jTrip);
                  localStorage.selectedTrip = JSON.stringify(cookieTrip);
                  document.cookie = "selectedTrip=" + JSON.stringify(cookieTrip) + "; expires=0; path=/";
