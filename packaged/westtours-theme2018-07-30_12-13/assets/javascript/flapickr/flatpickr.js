  ...
  function FlatpickrInstance(element, instanceConfig) {
    ...
    function init() {
      ...
      if (self.daysContainer !== undefined) {
        var daysWidth = (self.calendarContainer.clientWidth + 1) * self.config.showMonths +
          "px";
    ...
    function bindEvents() {
      ...
      if (self.timeContainer !== undefined &&
        ...
        bind(self.timeContainer, ["wheel", "input", "increment"], self._debouncedChange, {
          passive: true
        });
    ...
    function build() {
      ...
      self.calendarContainer = createElement("div", "flatpickr-calendar-av");
    ...
    function buildDays() {
      ...
      for (var i = 0; i < self.config.showMonths; i++) {
        ...
        self.daysContainer.appendChild(buildMonthDays(d.getFullYear(), d.getMonth()));
      }
    ...
    function onMouseOver(elem) {
      ...
      for (var m = 0; m < self.config.showMonths; m++) {
        ...
        var _loop_1 = function(i) {
          var date = month.children[i].dateObj;
          ...
          var minRangeDate = rangeStartDate,
