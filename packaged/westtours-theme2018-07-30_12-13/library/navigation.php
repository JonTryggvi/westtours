...
if ( ! function_exists( 'foundationpress_top_bar_c' ) ) {
	function foundationpress_top_bar_c() {
		wp_nav_menu( array(
			'container'      => false,
			'menu_class'     => 'dropdown menu',
			'items_wrap'     => '<div><ul id="%1$s" class="%2$s desktop-menu" data-dropdown-menu >%3$s</ul></div>',
...
if ( ! function_exists( 'foundationpress_lang' ) ) {
	function foundationpress_lang() {
		wp_nav_menu( array(
			'container'      => false,                         // Remove nav container
			'menu'           => __( 'lang', 'foundationpress' ),
			'menu_class'     => 'dropdown menu langMenu',
			'theme_location' => 'lang',
			'items_wrap'     => '<ul id="%1$s" class="%2$s desktop-menu" data-dropdown-menu >%3$s</ul>',
			'fallback_cb'    => false,
			'walker'         => new Foundationpress_Mobile_Walker(),
...
if ( ! function_exists( 'foundationpress_mobile_lang' ) ) {
	function foundationpress_mobile_lang() {
		wp_nav_menu( array(
			'container'      => false,                         // Remove nav container
			'menu'           => __( 'lang', 'foundationpress' ),
			'menu_class'     => 'vertical menu',
