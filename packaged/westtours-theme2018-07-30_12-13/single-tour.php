	...
	<article <?php post_class('main-content'); ?> id="post-<?php the_ID(); ?>" data-tourid="<?php echo $tourId; ?>">
      ...
      <?php endif; ?>
		...
		<div class="entry-content <?php if(!$filter){echo 'setCalendar';} ?>">
			<section id="postImage" class="post-image" data-interchange="[<?php echo $nutrition_image['sizes']['fp-small'] ?>, small], [<?php echo $nutrition_image['sizes']['fp-medium'] ?>, medium], [<?php echo $nutrition_image['sizes']['fp-large'] ?>, large], [<?php echo $nutrition_image['sizes']['fp-large'] ?>, xlarge], [<?php echo $nutrition_image['sizes']['fp-retina'] ?>, xxlarge]">
