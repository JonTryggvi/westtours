  ...
  <form class="frmNavActivety">
    ...
    <div id="frmParty" class="frmParty frm">
      <div id="counterContainerM" class="counterContainer">
        <div class="counterContainer__listitem">
          <label for="adultM"><input id="txtAdultM" type="text" name="adult" value="<?php if ($sBookingPriceAdult) { echo $sBookingPriceAdult; } else { echo 0;} ?>" readonly>
        ...
        <div class="counterContainer__listitem" >
          <label for="children"><input id="txtChildM" type="text" name="children" value="<?php if ($sBookingPriceChild) { echo $sBookingPriceChild;} else {echo 0;} ?>" readonly></label>
        ...
        <div class="counterContainer__listitem">
          <label for="infant"><input id="txtInfantM" type="text" name="infant" value="<?php if ($sBookingPriceInfant) {
                   echo $sBookingPriceInfant;
               } else {
                   echo 0;
               } ?>" readonly>
           </label>
           <span>inftants 0 - 2</span>
          <div class="buttons">
            <button class="btnMinus" type="button" name="button"></button><button class="btnPlus" type="button" name="button"></button>
          </div>
        </div>
